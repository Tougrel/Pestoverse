...
<template>
    <button class="group break-inside-avoid rounded-lg w-full" @click="$emit('click')">
        <figure class="relative table rounded-lg bg-cover w-full" :style="{ backgroundImage: `url(${getPlaceholderImage(src)})` }">
            <img
                role="button"
