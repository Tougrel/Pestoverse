export default (lang: string) => [
    ...
    {
        filter: ["all", ["==", "$type", "LineString"], ["in", "class", "path", "footway", "construction"]],
        id: "highway_path",
        layout: {
            "line-cap": "round",
            "line-join": "round",
    ...
    {
        filter: ["all", ["!in", "class", "motorway", "trunk", "primary", "secondary", "tertiary"], ["==", "$type", "LineString"]],
        id: "highway_name_other",
        layout: {
            "symbol-avoid-edges": true,
            "symbol-placement": "line",
            "symbol-spacing": 350,
            "text-field": ["coalesce", ["get", `name:${lang}`], ["get", "name:en"], ["get", "name:latin"], ["get", "name"]],
    ...
    {
        filter: ["all", ["==", "subclass", "park"], ["==", "rank", 1], ["==", "$type", "Point"]],
        id: "poi_gen0_parks",
        layout: {
            "symbol-avoid-edges": true,
            "text-anchor": "center",
    ...
    {
        filter: ["all", ["in", "subclass", "university", "hospital"], ["<=", "rank", 3], ["==", "$type", "Point"]],
        id: "poi_gen0_other",
        layout: {
            "symbol-avoid-edges": true,
            "text-anchor": "center",
    ...
    {
        filter: ["all", ["!in", "class", "city", "suburb", "town", "village"], ["==", "$type", "Point"]],
        id: "place_other",
        layout: {
            "symbol-avoid-edges": true,
            "text-anchor": "center",
    ...
    {
        filter: ["all", ["in", "class", "trunk", "primary", "secondary", "tertiary"], ["==", "$type", "LineString"]],
    ...
    {
        filter: ["all", ["<=", "ref_length", 6], ["==", "$type", "LineString"], ["!in", "network", "us-highway", "us-state", "us-interstate"]],
    ...
    {
        filter: ["all", ["<=", "ref_length", 3], ["==", "$type", "LineString"], ["==", "network", "us-interstate"]],
    ...
    {
        filter: ["all", ["==", "$type", "Point"], ["all", ["==", "class", "country"], [">=", "rank", 2]]],
    ...
    {
        filter: ["all", ["==", "$type", "Point"], ["all", ["<=", "rank", 1], ["==", "class", "country"]]],
